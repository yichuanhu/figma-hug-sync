...
const TemplateDetailDrawer = ({
  ...
  const mockUsageRecords = [
    { id: '1', task_name: `${template.template_name}-任务-001`, created_by_name: 'John Smith', created_at: '2026-01-28 14:30:25', status: 'SUCCESS' },
    { id: '2', task_name: `${template.template_name}-任务-002`, created_by_name: 'Jane Doe', created_at: '2026-01-27 10:15:42', status: 'FAILED' },
    { id: '3', task_name: `${template.template_name}-任务-003`, created_by_name: 'Mike Wang', created_at: '2026-01-25 09:08:33', status: 'SUCCESS' },
  ];
