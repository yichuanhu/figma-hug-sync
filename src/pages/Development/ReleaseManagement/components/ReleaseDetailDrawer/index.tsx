...
const ReleaseDetailDrawer: React.FC<ReleaseDetailDrawerProps> = ({
  ...
  const groupedResources = useMemo(() => {
    ...
    const mockResources = [
      ...
      { resource_id: 'cred-001', resource_type: 'CREDENTIAL' as ResourceType, resource_name: 'ERP系统凭据', test_value: '********', production_value: '********', use_test_as_production: false, is_previously_published: true, is_manual: false, used_by_processes: ['订单处理流程', '数据同步流程'] },
      { resource_id: 'cred-002', resource_type: 'CREDENTIAL' as ResourceType, resource_name: '邮件服务凭据', test_value: '********', production_value: '********', use_test_as_production: true, is_previously_published: false, is_manual: false, used_by_processes: ['通知发送流程'] },
