...
const ProcessIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <foreignObject x="8" y="7" width="50" height="50">
      <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4px)',clipPath:'url(#bgblur_process_clip)',height:'100%',width:'100%'}}></div>
    </foreignObject>
...
const RobotIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <foreignObject x="-3" y="1" width="50" height="56">
      <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4px)',clipPath:'url(#bgblur_robot_clip)',height:'100%',width:'100%'}}></div>
    </foreignObject>
...
const TaskIcon = () => (
  <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <foreignObject x="-2" y="5" width="51" height="52.2979">
      <div xmlns="http://www.w3.org/1999/xhtml" style={{backdropFilter:'blur(4px)',clipPath:'url(#bgblur_task_clip)',height:'100%',width:'100%'}}></div>
    </foreignObject>
