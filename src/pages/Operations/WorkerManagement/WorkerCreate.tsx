    ...
    <AppLayout>
      <div className="worker-form">
        <div className="worker-form-header">
          <Title heading={3} className="worker-form-header-title">{t('worker.create.title')}</Title>
        ...
        <div className="worker-form-container">
          ...
          <Card title={t('worker.create.runtimeConfig')} className="worker-form-card">
            <div className="worker-form-card-content">
              ...
              {useSameDevice && (
                <div className="worker-form-field">
                  <Text strong className="worker-form-label">{t('worker.create.fields.selectWorker')}</Text>
                  <Select value={existingWorkerId} onChange={(v) => setExistingWorkerId(v as string)} className="worker-form-select-full" placeholder={t('createProcess.fields.relatedRequirementPlaceholder')}>
          ...
          <Card title={t('worker.create.connectionParams')} className="worker-form-card">
            <div className="worker-form-card-content">
              ...
              {desktopType === 'Console' && (
                <div className="worker-form-field">
                  <Text strong className="worker-form-label">{t('worker.create.fields.unlockScreen')}</Text>
              ...
              <div className="worker-form-field">
                <Text strong className="worker-form-label">{t('worker.create.fields.forceLogin')}</Text>
