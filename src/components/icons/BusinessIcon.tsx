...
const BusinessIcon = ({ size = 20, className }: IconProps) => (
  ...
  >
    {/* 底部阴影/支架 */}
    <path d="M19.7778 15.8182C21.0051 15.8182 22 17.1613 22 18.8182C22 20.475 21.0051 21.8182 19.7778 21.8182H4.22222C2.99492 21.8182 2 20.475 2 18.8182C2 17.1613 2.99492 15.8182 4.22222 15.8182H19.7778Z" fill="url(#biz_grad0)"/>
    {/* 主屏幕 */}
    <path d="M2.18182 6.54546C2.18182 4.13549 4.13549 2.18182 6.54546 2.18182H17.4546C19.8645 2.18182 21.8182 4.13549 21.8182 6.54546V14.7273C21.8182 17.1372 19.8645 19.0909 17.4546 19.0909H6.54546C4.13549 19.0909 2.18182 17.1372 2.18182 14.7273V6.54546Z" fill="url(#biz_grad1)"/>
    {/* 图表线 */}
    ...
    <defs>
      <linearGradient id="biz_grad0" x1="12" y1="15.8182" x2="12" y2="21.8182" gradientUnits="userSpaceOnUse">
        <stop stopColor="#0077FA"/>
        <stop offset="1" stopColor="#113CC2"/>
      </linearGradient>
      <linearGradient id="biz_grad1" x1="12" y1="2" x2="12" y2="19.0909" gradientUnits="userSpaceOnUse">
