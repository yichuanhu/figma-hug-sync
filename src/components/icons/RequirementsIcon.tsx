...
const RequirementsIcon = ({ size = 20, className }: IconProps) => {
  const id = useId();
  const grad0 = `req_grad0_${id}`;
  const grad1 = `req_grad1_${id}`;
  ...
  return (
    ...
    >
      ...
      <defs>
        <linearGradient id={grad0} x1="6.54543" y1="8.72727" x2="6.54543" y2="22.9091" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0077FA"/>
          <stop offset="1" stopColor="#113CC2"/>
        </linearGradient>
        <linearGradient id={grad1} x1="15.2727" y1="1" x2="15.2727" y2="21.8182" gradientUnits="userSpaceOnUse">
