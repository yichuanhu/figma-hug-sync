...
const ParameterManagementContent = ({ context }: ParameterManagementContentProps) => {
  ...
  const columns = [
    ...
    }] : []),
    {
      ...
      width: 100,
      ellipsis: true,
      render: (text: string, record: LYParameterResponse) => text ? <UserNameWithCard name={text} userId={record.created_by} department={record.created_by_department || undefined} role={record.created_by_role || undefined} email={record.created_by_email || undefined} /> : '-',
    },
    {
