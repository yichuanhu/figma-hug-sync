...
const generateMockLYProcessResponse = (index: number): LYProcessResponse => {
  ...
  const mockDependencies: LYProcessDependency[] = [
    ...
    { resource_id: `queue-auto-${index}-1`, resource_name: 'High_Priority_Order_Processing_Queue_For_Enterprise_Customers_Region_APAC_With_Dead_Letter_Retry_Policy', resource_type: 'QUEUE' as const, source: 'AUTO_DETECTED' as const, resource_value: '24 messages pending' },
    { resource_id: `file-auto-${index}-1`, resource_name: 'Enterprise_Order_Invoice_Template_With_MultiLanguage_Support_And_Regional_Tax_Compliance_2024_v3.xlsx', resource_type: 'FILE' as const, source: 'AUTO_DETECTED' as const, original_name: 'Enterprise_Order_Invoice_Template_With_MultiLanguage_Support_And_Regional_Tax_Compliance_2024_v3.xlsx', resource_value: 'Enterprise_Order_Invoice_Template_With_MultiLanguage_Support_And_Regional_Tax_Compliance_2024_v3.xlsx' },
    ...(index % 2 === 0 ? [
