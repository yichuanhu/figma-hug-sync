...
// ============= API Methods =============
// API 方法将在实际后端集成时启用，目前仅导出类型定义供组件使用
// 
// 后端集成时使用以下方式导入：
// import { LYBaseApp } from '@monorepo/uci';
// 
// export const processApi = {
//   getProcesses: (params: GetProcessesParams) => LYBaseApp.get('apa').httpClient.get<GetProcessesData>(`/processes`, params),
//   addProcesses: (params: LYCreateProcessRequest) => LYBaseApp.get('apa').httpClient.post<AddProcessesData>(`/processes`, params),
//   // ... 其他方法
// };
